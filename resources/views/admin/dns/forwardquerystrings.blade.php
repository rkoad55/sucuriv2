...
>>>>>>> 682dded0748d400b51254855d777a695ec5ca0f4
            {{-- For Error --}}
                ...
                @endif
                <h2 style="font-size: 20px !important;">Forward Query Strings </h2>
	...
	<div class="row" style="background: white;">
                <div class="col-xs-12" style="width: 100%;">
                    <div class="panel panel-success">
  					...
  					<h3>Forward Query Strings</h3>
     
  					 <form method="get"  role="form" action="/forwardQueryStringsMode">     
               <input type="hidden" name="domain" value="{{$sucuri_user->url}}"> 
                  
                        <select  name="value" id="value" required class="form-control">
