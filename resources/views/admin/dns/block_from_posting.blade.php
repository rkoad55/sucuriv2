...
//  die();  ?>
 @if(session()->has('message'))
    ...
    {{ session()->get('message') }}
		<meta http-equiv = "refresh" content = "2; url = {{action('Admin\DnsController@block_from_posting',Request::segment(2))}}" />
    ...
    @endif
            {{-- For Error --}}
                ...
                @endif
                <h2 style="font-size: 20px !important;">Block From Posting </h2>
                ...
                <div class="col-xs-12" style="width: 100%;">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body" >
                            ...
                            <form method="get"  role="form" action="insertBlock_from_posting"  > 
                  ...
                  <tbody>
                      <tr>
                          ...
                          <td>
                              ...
                              <form method="get" action="removeblock_fromposting">
                              <input name="_token" type="hidden" value="{{ csrf_token() }}"/> 
                                      <table >
